...
AlertDot = class AlertDot extends Component {
  render(props, state) {
    ...
    if (props.color) {
      ...
      alert_style.background = this.context.__theme.secondary.error;
    } else {
      alert_style.background = this.context.__theme.secondary.highlight;
    }
    return h('div', {
...
var AlertOverlay, Component, Overlay, Slide, cn, css, h;

Overlay = __webpack_require__(/*! ./Overlay.coffee */ "./components/Overlay.coffee");

({Component, h} = __webpack_require__(/*! preact */ "preact"));

Slide = __webpack_require__(/*! preact-slide */ "preact-slide");
...
AlertOverlay = class AlertOverlay extends Component {
  ...
  render(props, state) {
    ...
    if (this.state.alert_type === 'error') {
      alert_bg = this.context.__theme.primary.false;
    } else if (this.state.alert_type === 'success') {
      alert_bg = this.context.__theme.primary.true;
    } else {
      alert_bg = this.context.__theme.primary.inv[0];
    }
    alert_color = 'white';
    return h(Overlay, {
...
Bar = class Bar extends Component {
  ...
  render(props, state) {
    ...
    return h('div', bar_props, props.children);
  }
...
module.exports = Chip = class Chip extends Component {
  constructor() {
    super(...arguments);
  ...
  getButtonStyle(props, state) {
    ...
    if (props.btn_type === 'primary') {
      if (select) {
        btn_style.color = this.context.__theme.secondary.inv[1];
        btn_style.background = this.context.__theme.secondary.color[0];
      } else if (focus) {
        btn_style.color = this.context.__theme.secondary.inv[1];
        btn_style.background = this.context.__theme.secondary.color[0];
      } else {
        btn_style.color = this.context.__theme.secondary.inv[2];
        btn_style.background = this.context.__theme.secondary.color[1];
      }
    } else if (props.btn_type === 'flat') {
      if (select) {
        btn_style.color = this.context.__theme.primary.color[1];
        btn_style.background = this.context.__theme.primary.inv[1];
      } else if (focus) {
        btn_style.color = this.context.__theme.primary.color[1];
        btn_style.background = this.context.__theme.primary.inv[1];
      } else {
        btn_style.color = this.context.__theme.primary.color[2];
        btn_style.background = this.context.__theme.primary.inv[0];
      }
    } else {
      if (select) {
        btn_style.color = this.context.__theme.primary.color[1];
        btn_style.background = this.context.__theme.primary.inv[2];
      } else if (focus) {
        btn_style.color = this.context.__theme.primary.color[1];
        btn_style.background = this.context.__theme.primary.inv[2];
      } else {
  ...
  render(props, state) {
    ...
    return h('span', chip_props, props.children);
  }
...
var AlertDot, Color, Component, Input, Slide, cn, css, h,
  boundMethodCheck = function(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new Error('Bound instance method accessed before binding'); } };
...
Input = class Input extends Component {
  ...
  onKeyDown(e) {
    ...
    if (e.code === 'Enter' && this.props.type === 'checkbox') {
      return this._input.click();
    } else if (this.props.type === 'list') {
      if ((e.code === 'Enter') && this.props.value) {
        return typeof (base = this.props).onInput === "function" ? base.onInput(this.props.value + ',') : void 0;
      } else if (e.code === 'Backspace' && !this._input.value && this.props.value) {
  ...
  getButtonStyle(props, state) {
    ...
    if (props.btn_type === 'primary') {
      if (select) {
        btn_style.color = this.context.__theme.secondary.inv[0];
        btn_style.background = this.context.__theme.secondary.color[0];
      } else if (focus) {
        btn_style.color = this.context.__theme.secondary.inv[0];
        btn_style.background = this.context.__theme.secondary.color[0];
      ...
      if (select) {
        btn_style.color = this.context.__theme.primary.color[0];
        btn_style.background = this.context.__theme.primary.inv[1];
      } else if (focus) {
        btn_style.color = this.context.__theme.primary.color[0];
        btn_style.background = this.context.__theme.primary.inv[1];
  ...
  getChipStyle(props, state, offset) {
    ...
    if (props.btn_type === 'primary') {
      btn_style.color = this.context.__theme.secondary.inv[0];
      btn_style.background = this.context.__theme.secondary.color[2];
    } else if (props.btn_type === 'flat') {
      btn_style.color = this.context.__theme.primary.color[0];
      btn_style.background = this.context.__theme.primary.inv[2];
    } else {
      btn_style.color = this.context.__theme.primary.inv[0];
      btn_style.background = this.context.__theme.primary.color[2];
    }
    return btn_style;
  }
  ...
  getIconStyle(props, state) {
    ...
    if (props.i_type === 'primary') {
      i_style.color = this.context.__theme.secondary.color[0];
    } else if (props.i_type === 'highlight') {
      i_style.color = this.context.__theme.secondary.highlight;
    } else {
      if (props.btn_type === 'primary') {
        if (focus || select) {
          i_style.color = this.context.__theme.secondary.inv[0];
        } else {
          i_style.color = this.context.__theme.secondary.inv[2];
        }
      } else if (props.btn_type === 'flat') {
        if (focus || select) {
          i_style.color = this.context.__theme.primary.color[2];
        } else {
          i_style.color = this.context.__theme.primary.color[3];
        }
      } else {
        if (focus || select) {
          i_style.color = this.context.__theme.primary.color[0];
        } else {
          i_style.color = this.context.__theme.primary.color[1];
        }
      }
    }
    return i_style;
  ...
  getBarStyle(props, state) {
    ...
    if (!value) {
      if (props.required && !props.value) {
        bar_style.background = this.context.__theme.secondary.warn;
      } else if (props.btn_type === 'primary') {
        bar_style.background = this.context.__theme.secondary.color[0];
      } else if (props.btn_type === 'flat') {
        bar_style.background = this.context.__theme.primary.inv[1];
      } else {
        bar_style.background = this.context.__theme.primary.inv[2];
      }
    } else if (props.invalid === true || props.is_valid === false) {
      bar_style.background = this.context.__theme.secondary.false;
    } else if (props.invalid === false || props.is_valid === true) {
      bar_style.background = this.context.__theme.secondary.true;
    } else if (props.color === 'color') {
      bar_style.background = props.value;
    } else {
      if (props.btn_type === 'primary') {
        bar_style.background = this.context.__theme.secondary.inv[0];
      } else if (props.btn_type === 'flat') {
        bar_style.background = this.context.__theme.primary.color[1];
      } else {
        bar_style.background = this.context.__theme.primary.color[2];
      }
    }
  ...
  render(props, state) {
    var alert, bar, chips, color_circle, focus, icon, input, input_hidden, input_props, label, ref, select, self_input_props, style, toggle, toggle_bar_off_style, toggle_bar_on_style, toggle_bar_style, value;
    value = props.value != null ? props.value : state.value;
    select = props.select;
    ...
    if (props.type === 'checkbox') {
      toggle_bar_on_style = {
        background: this.context.__theme.secondary.true
      };
      toggle_bar_off_style = {
        background: this.context.__theme.secondary.false
      };
      if (props.btn_type === 'primary') {
        toggle_bar_style = {
          background: this.context.__theme.secondary.color[0]
        };
      } else if (props.btn_type === 'flat') {
        toggle_bar_style = {
          background: this.context.__theme.primary.inv[1]
        };
      } else {
        toggle_bar_style = {
          background: this.context.__theme.primary.inv[2]
        };
      }
      toggle = h(Slide, {
        width: 30,
    ...
    if (props.label) {
      label = h('div', {
        style: {
          color: props.top_label && this.context.__theme.primary.color[0] || void 0
        },
    ...
    if (props.type !== 'button' && props.type !== 'label') {
      ...
      if (props.type === 'textarea') {
        ...
        input = h('select', input_props, (ref = props.options) != null ? ref.map(function(opt) {
          return h('option', {
            value: opt
          }, opt);
        }) : void 0);
    ...
    return h(props.href && 'a' || 'div', {
      ...
      href: props.href,
      style: style
    }, chips, icon, label, toggle, bar, input, color_circle, alert, props.children);
  }
...
var Bar, Color, Component, Menu, css, h, render,
  boundMethodCheck = function(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new Error('Bound instance method accessed before binding'); } };

({h, render, Component} = __webpack_require__(/*! preact */ "preact"));
...
Menu = class Menu extends Component {
  ...
  getChildContext() {
    ...
    return {
      ...
      clearTabBranch: this.clearTabBranch,
      ...
      selectedTabClassName: this.props.selectedTabClassName,
  ...
  spliceTabBranch(tab) {
    boundMethodCheck(this, Menu);
    this.state.tab_branch.splice(this.state.tab_branch.indexOf(tab));
    return this.setState();
  }
...
var Bar, Component, MenuTab, Overlay, css, h,
  boundMethodCheck = function(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new Error('Bound instance method accessed before binding'); } };
...
MenuTab = class MenuTab extends Component {
  ...
  componentWillUpdate(props, state) {
    ...
    if (this.state.skipped_last_children_render && this.state.render_children) {
      ...
      force_update = true;
    } else if (!this.state.render_children && this.props.children.length) {
  ...
  render(props, state) {
    var backdrop, bar, bar_style, flex_dir, reveal, tab_style;
    ...
    if (props.children.length && !props.disabled && props.content) {
      if (props.content.attributes && !(props.content.attributes.select != null)) {
    ...
    if (!this.state.render_children) {
      return h('div', {
        ...
        onMouseLeave: this.state.hover_reveal_enabled && this.onTabMouseLeave,
        onMouseEnter: this.state.hover_reveal_enabled && this.onTabMouseEnter,
...
var Color, Component, Overlay, cn, css, h,
  boundMethodCheck = function(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new Error('Bound instance method accessed before binding'); } };
...
Overlay = class Overlay extends Component {
  ...
  componentWillMount() {
    if (!this.props.transparent) {
      this.state.backdrop_color = this.props.backdrop_color || this.context.__theme.primary.inv[0];
  ...
  componentWillUpdate(props, state) {
    if (props.backdrop_color !== this.props.backdrop_color || (this.context.__theme.primary.inv[0] !== this.state.backdrop_color)) {
      if (!props.transparent) {
        state.backdrop_color = props.backdrop_color || this.context.__theme.primary.inv[0];
  ...
  render(props, state) {
    ...
    return h('div', {
      onClick: props.onClick,
      className: cn(css['overlay'], !this.state.visible && css['overlay-hidden'], props.className, props.transparent && css['overlay-transparent']),
      style: overlay_style
    }, props.children);
  }
...
var Section, cn, css, h;

({h} = __webpack_require__(/*! preact */ "preact"));
...
Section = class Section {
  render(props) {
    ...
    return h('div', section_props, h('h2', {
      className: css['section-title'],
      style: {
        opacity: 0.7,
        color: this.context.__theme.primary.color[2]
      }
    }, title, h('div', {
...
SquareLoader = class SquareLoader {
  render(props) {
    return h('div', {
      style: {
...
var Color, Component, Style, css,
  boundMethodCheck = function(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new Error('Bound instance method accessed before binding'); } };

Color = __webpack_require__(/*! color */ "color");

({Component} = __webpack_require__(/*! preact */ "preact"));
...
Style = class Style extends Component {
  ...
  renderStyle(props) {
    ...
    if (secondary_c.isLight()) {
      return this.secondary = this.darkenPallet(secondary_c, props.secondary_factors);
    } else {
      return this.secondary = this.lightenPallet(secondary_c, props.secondary_factors);
    }
  }
...
var content = __webpack_require__(/*! !../node_modules/css-loader??ref--6-1!../node_modules/less-loader/dist/cjs.js!./Style.less */ "./node_modules/css-loader/index.js??ref--6-1!./node_modules/less-loader/dist/cjs.js!./components/Style.less");
...
module.exports = {
  Header: __webpack_require__(/*! ./Header.coffee */ "./components/Header.coffee"),
  Bar: __webpack_require__(/*! ./Bar.coffee */ "./components/Bar.coffee"),
  Input: __webpack_require__(/*! ./Input.coffee */ "./components/Input.coffee"),
  Menu: __webpack_require__(/*! ./Menu.coffee */ "./components/Menu.coffee"),
  MenuTab: __webpack_require__(/*! ./MenuTab.coffee */ "./components/MenuTab.coffee"),
  Section: __webpack_require__(/*! ./Section.coffee */ "./components/Section.coffee"),
  Style: __webpack_require__(/*! ./Style.coffee */ "./components/Style.coffee"),
  AlertDot: __webpack_require__(/*! ./AlertDot.coffee */ "./components/AlertDot.coffee"),
  Overlay: __webpack_require__(/*! ./Overlay.coffee */ "./components/Overlay.coffee"),
  AlertOverlay: __webpack_require__(/*! ./AlertOverlay.coffee */ "./components/AlertOverlay.coffee"),
  SquareLoader: __webpack_require__(/*! ./SquareLoader.coffee */ "./components/SquareLoader.coffee"),
  Chip: __webpack_require__(/*! ./Chip.coffee */ "./components/Chip.coffee")
};
...
/***/ "./node_modules/css-loader/index.js??ref--6-1!./components/Font.css":
/*!*****************************************************************!*\
...
/***/ "./node_modules/css-loader/index.js??ref--6-1!./node_modules/less-loader/dist/cjs.js!./components/Style.less":
/*!**********************************************************************************************************!*\
...
/***/ "preact-slide":
/*!*******************************!*\
  !*** external "preact-slide" ***!
  \*******************************/
/*! no static exports found */
/***/ (function(module, exports) {

module.exports = require("preact-slide");
